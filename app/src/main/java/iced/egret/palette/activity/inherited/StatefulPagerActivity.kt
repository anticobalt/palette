...
/**
 * A pager activity that depends on the the state of the app to be correct (i.e. [iced.egret.palette.util.CollectionManager]
 * and [iced.egret.palette.util.Storage] to be set up properly) to function.
 */
